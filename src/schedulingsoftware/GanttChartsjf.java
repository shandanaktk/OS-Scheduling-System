...
public class GanttChartsjf extends JFrame {
    private List<Integer> burstTimes;
    private List<Integer> processIds;

    public GanttChartsjf(List<Integer> burstTimes, List<Integer> processIds) {
    ...
    class GanttChartPanel extends JPanel {
        ...
        private void drawGanttChart(Graphics g) {
            ...
            int x = 30; // X position for the bar
            ...
            for (int i = 0; i < burstTimes.size(); i++) {
                ...
                int processId = processIds.get(i); // Get the original process ID
                ...
                String processIdText = "P" + processId;
